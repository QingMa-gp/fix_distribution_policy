...
# Example
```bash
# generate commands for database "postgres" on port 6000, and print to file "alter_cmds.out"
...
# run commands from file "alter_cmds.out" using two concurrent workers
